 <?php  global $post; $postcontent = get_post_meta( $post->ID, '_horseclub_post_type', true );$slideheight = 238; $slidewidth = 424;  ?>
...
<div class="datahead">
	<span class="postaut">
	<span class="postdate"><i class="fa fa-clock-o"></i> <?php echo get_the_date('j'); ?>. <?php echo get_the_date('M');?></span> / <?php echo esc_html__('by', 'horseclub');?>  <a href="<?php echo get_author_posts_url(get_the_author_meta('ID')); ?>" rel="author"><?php echo get_the_author() ?></a>  /  
