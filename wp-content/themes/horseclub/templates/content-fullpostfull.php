...
<div class="datahead">
	<span class="postaut"><?php if ( is_sticky() ){echo '<i class="fa fa-paperclip"></i>';}?>
	<span class="postdate"><?php echo get_the_date('j'); ?>. <?php echo get_the_date('M');?></span> / <?php echo esc_html__('by', 'horseclub');?>  <a href="<?php echo get_author_posts_url(get_the_author_meta('ID')); ?>" rel="author"><?php echo get_the_author() ?></a>  / 
    </span>
