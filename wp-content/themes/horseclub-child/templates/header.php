...
<?php
global $horseclub_usefulpi;
if ($horseclub_usefulpi['menu_layout'] == 'up_popup_menu') {
    ?>
    <!-- PopUp Menu -->
    <div class="main-navm pop-visible <?php
    global $horseclub_usefulpi;
    if ($horseclub_usefulpi['sub_color_menu'] == '1') {
        echo 'dark';
    } else {
        echo "white";
    }
...
<?php
global $horseclub_usefulpi;
if ($horseclub_usefulpi['display_search'] == '1') {
    ?>
...
<?php } ?>
<header class="normal <?php
if (get_post()) {
    global $post;
    $id = get_the_ID();
    $headcolor = get_post_meta($id, '_horseclub_headcolor', true);
    echo $headcolor;
} echo "\x20";
if (isset($horseclub_usefulpi['sub_color_menu'])) {
    if ($horseclub_usefulpi['sub_color_menu'] == '1') {
        echo 'dark';
    } else {
        echo "white";
...
?>">
    ...
    <?php
    global $horseclub_usefulpi;
    if ($horseclub_usefulpi['display_top_bar'] == '1') {
        ?>
        <div class="top-bar-section">
            <div class="container tbs"> 
                <div class="col-md-6 top_bar_left"> 
                    <?php
                    if (isset($horseclub_usefulpi['sec_top_left_text'])) {
                        $sec_left = $horseclub_usefulpi['sec_top_left_text'];
                    } echo do_shortcode($sec_left);
                    ?>
                </div>
                <div class="col-md-6 top_bar_right"> 
                    <?php
                    if (isset($horseclub_usefulpi['sec_top_right_text'])) {
                        $sec_right = $horseclub_usefulpi['sec_top_right_text'];
                    } echo do_shortcode($sec_right);
                    ?>
                </div>
            </div>
        </div><!-- Top Bar end -->	
    ...
    <?php
    global $horseclub_usefulpi;
    if (isset($horseclub_usefulpi['menu_layout'])) {
        ...
        if ($horseclub_usefulpi['menu_layout'] == 'up_top_menu') {
            ...
            global $post;
            $id = get_the_ID();
            $stih = get_post_meta($id, '_horseclub_head_s', true);
            $nw = get_post_meta($id, '_horseclub_nav_w', true);
            ?>
            <div id="up_topbar" class="topclass <?php
            if ($stih != '') {
                echo $stih;
            } else {
                echo 'enable_sticky';
            ...
            ?>">
                ...
                ?>">
                    <div class="row">
                            ...
                            <div class="topbarmenu clearfix">
                                ...
                                <div id="logo" class="logocase">
                                    <a class="brand logofont" href="<?php echo esc_url(home_url('/')); ?>">
                                        <?php
                                        global $horseclub_usefulpi;
                                        if (!empty($horseclub_usefulpi['x1_usefulpi_logo_upload']['url'])) {
                                            ?>
                                            <div id="uplogo">
                        ...
                        <?php
                        global $horseclub_usefulpi;
                        if (isset($horseclub_usefulpi['display_shopicon'])) {
                                ...
                                <div class="topbarmenu">
                                    ...
                                    <div id="logo" class="logocase">
                                        <a class="brand logofont" href="<?php echo esc_url(home_url('/')); ?>">
                                            ...
                                            global $horseclub_usefulpi;
                                            if (!empty($horseclub_usefulpi['x1_usefulpi_logo_upload']['url'])) {
                                                ?> <div id="uplogo"><img src="<?php echo $horseclub_usefulpi['x1_usefulpi_logo_upload']['url']; ?>" alt="<?php bloginfo('name'); ?>" class="up-logo" />
                                                    <?php if (!empty($horseclub_usefulpi['x2_usefulpi_logo_upload']['url'])) { ?> <img src="<?php echo $horseclub_usefulpi['x2_usefulpi_logo_upload']['url']; ?>" class="retina-logo" alt="<?php bloginfo('name'); ?>" /> <?php } ?>
                                                </div>
                                                <?php
                                            } else {
            ...
            <!-- Logo Centar -->
        <?php } else if ($horseclub_usefulpi['menu_layout'] == 'up_centar_menu') {
            ?>
            <?php
            $turn_off_s = '';
            global $post;
            $id = get_the_ID();
            $stih = get_post_meta($id, '_horseclub_head_s', true);
            $stih_on = get_post_meta($id, '_horseclub_head_s_on', true);
                                        ...
                                        if (class_exists('woocommerce')) {
                                            ...
                                            <div class="shop_icon"> 
                                                <a class="cart-ic" 
                                                   ...
                                                   title="<?php esc_html_e('View your shopping cart', 'horseclub'); ?>">
                                                    <i class="fa fa-cart-arrow-down"></i></a> 
                                                <?php
                                                if (version_compare(WOOCOMMERCE_VERSION, "2.0.0") >= 0) {
                                                    the_widget('WC_Widget_Cart', 'title= ');
                                ...
                                <div class="topnav-right">
                                    <div class="topbarmenu clearfix">
                                        <nav id="nav-main" class="clearfix" role="navigation">
                                            <?php
                                            if (has_nav_menu('primary_navigation')) :
                                                wp_nav_menu(array('theme_location' => 'primary_navigation', 'menu_class' => 'sf-menu', 'fallback_cb' => 'horseclub_bootstrap_navwalker_childtheme::fallback', 'walker' => new horseclub_bootstrap_navwalker_childtheme()));
                                            endif;
                                            ?>
                                        </nav> 
                                    </div>
            ...
            <?php } else if ($horseclub_usefulpi['menu_layout'] == 'up_popup_menu_x') {
                ?>
                <?php
                global $post;
                $id = get_the_ID();
                ...
                <!-- PopUp Menu -->
                <div class="main-navm left pop-visible <?php
                global $horseclub_usefulpi;
                if ($horseclub_usefulpi['sub_color_menu'] == '1') {
                    echo 'dark';
                } else {
...
<div id="overlayEq" style="display: none;"></div>

<?php echo do_shortcode("[btn_emergencia]"); ?>